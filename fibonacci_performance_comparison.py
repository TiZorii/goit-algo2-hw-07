...
# Реалізація LRU Cache для обчислення чисел Фібоначчі
...
# Реалізація Splay Tree для обчислення чисел Фібоначчі
class SplayTreeNode:
...
# Функція для обчислення числа Фібоначчі за допомогою Splay Tree
...
# Вимірювання часу виконання для LRU Cache та Splay Tree
def measure_time():
...
def plot_results():
    ...
    # Таблиця результатів з кольоровим виводом
    print(
